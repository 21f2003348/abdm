...
def register_care_context_to_gateway(patient_abha_id: str, care_context_id: str, context_name: str, hip_id: str = "HOSPITAL-1"):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            # Step 2: Create linking request in gateway
            try:
            ...
            # Step 3: Create consent request for the care context
            try:
...
def init_db():
    ...
    try:
        ...
        if existing_patients == 0:
            ...
            hospital_bridge_id = os.getenv("BRIDGE_ID_HIP") or os.getenv("BRIDGE_ID") or "HOSPITAL-1"
